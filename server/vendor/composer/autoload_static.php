...
class ComposerStaticInita71069ba2ce3bfa12aaa8e7919b81308
{
    ...
    public static $classMap = array (
        'App\\Api' => __DIR__ . '/../..' . '/src/router/Api.php',
        'App\\Controller' => __DIR__ . '/../..' . '/src/controllers/Controller.php',
        'App\\Db' => __DIR__ . '/../..' . '/src/db/Db.php',
        'App\\Env' => __DIR__ . '/../..' . '/src/utils/Env.php',
        'App\\Model' => __DIR__ . '/../..' . '/src/models/Model.php',
        'App\\ModelInterface' => __DIR__ . '/../..' . '/src/models/ModelInterface.php',
        'App\\ProductController' => __DIR__ . '/../..' . '/src/controllers/ProductController.php',
        'App\\ProductModel' => __DIR__ . '/../..' . '/src/models/Product.php',
        'App\\ProductRepository' => __DIR__ . '/../..' . '/src/repositories/db/ProductRepository.php',
        'App\\PropertyModel' => __DIR__ . '/../..' . '/src/models/Property.php',
        'App\\Route' => __DIR__ . '/../..' . '/src/router/Route.php',
        'App\\RouteTrait' => __DIR__ . '/../..' . '/src/router/Traits/RouteTrait.php',
        'App\\Router' => __DIR__ . '/../..' . '/src/router/Router.php',
        'App\\RouterInterface' => __DIR__ . '/../..' . '/src/router/RouterInterface.php',
        'App\\TypeModel' => __DIR__ . '/../..' . '/src/models/Type.php',
        'App\\UrlGenerator' => __DIR__ . '/../..' . '/src/router/UrlGenerator.php',
        'App\\Validation' => __DIR__ . '/../..' . '/src/utils/Validation.php',
        'App\\ValidationInterface' => __DIR__ . '/../..' . '/src/utils/ValidationInterface.php',
